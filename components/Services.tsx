        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-brand-card p-8 rounded border border-slate-800 hover:border-brand-cyan/50 transition-all duration-300 hover:-translate-y-1 cursor-pointer"
            >
              {/* Hover Glow Effect */}
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <p className="text-slate-400 text-sm mb-6 leading-relaxed border-b border-slate-800 pb-6 group-hover:border-brand-cyan/20 transition-colors flex-grow">
                  {service.description}
                </p>
                ...
                <div className="mt-auto pt-2 flex items-center text-sm text-slate-500 group-hover:text-brand-cyan transition-colors font-mono uppercase tracking-wider">
